...
export const createProductController = async (req, res) => {
  try {
    ...
    switch (true) {
      ...
      case !description:
        return res.send({ success: false, error: "Description is Required" });
      case !price:
        return res.send({ success: false, error: "Price is Required" });
      case !category:
        return res.send({ success: false, error: "Category is Required" });
      case !quantity:
        return res.send({ success: false, error: "Quantity is Required" });
...
export const productFiltersController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error in filtered product list controller",
      error,
    });
  }
};
